...
<template>
    <div
        ...
        <main class="flex-1 flex flex-col overflow-hidden relative">
            <div
                class="absolute top-0 right-0 w-[500px] h-[500px] bg-emerald-100/30 rounded-full blur-3xl -mr-64 -mt-64 pointer-events-none">
            </div>
            <div
            ...
            <header
                ...
                <div>
                    ...
                    <h2 class="text-2xl font-black text-slate-800 tracking-tight">
                        {{ route.name ? (route.name === 'partner' ? 'DASHBOARD' : route.name.replace('partner.',
                            '').toUpperCase()) : 'PARTNER PORTAL' }}
                    </h2>
                </div>
