...
<template>
    <div class="min-h-screen bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <div class="absolute -top-[10%] -left-[10%] w-[40%] h-[40%] bg-brand-primary/5 rounded-full blur-[100px]">
            </div>
            <div class="absolute bottom-[10%] -right-[5%] w-[30%] h-[30%] bg-brand-accent/5 rounded-full blur-[100px]">
            </div>
        </div>
                ...
                <div class="relative z-10">
                    <form @submit.prevent="isLogin ? handleLogin() : handleRegister()" class="space-y-5">
                        ...
                        <div v-if="!isLogin" class="space-y-2">
                            <label
                                class="block text-xs font-bold text-slate-700 uppercase tracking-wide">Username</label>
                            <input v-model="form.username" type="text" placeholder="e.g. johndoe" required
                                class="premium-input">
                        </div>

                        <div class="space-y-2">
                            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wide">Email or
                                Username</label>
