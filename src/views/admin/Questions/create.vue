                                    ...
                                    <div class="space-y-2.5">
                                        <div v-for="(opt, oIdx) in q.options" :key="oIdx"
                                            ...
                                            <div class="flex flex-col gap-2 grow min-w-0">
                                                ...
                                                <!-- Image preview or upload trigger -->
                                            ...
                                            <div class="flex flex-col space-y-1.5 md:col-span-2">
                                                <div class="bg-blue-50/60 border border-blue-100 rounded-xl p-3">
                                                    ...
                                                    <p class="text-[8px] text-blue-600 mt-1.5 leading-relaxed">
                                                        {{ currentLang === 'ar' ? 'سيتم حساب عدد الكلمات المكتوبة
                                                        تلقائياً وعرضها للمدرس عند التصحيح' : 'Word count will be
                                                        calculated and displayed to the teacher during grading' }}
                                                    </p>
                                                </div>
                                            </div>
                                        </template>
