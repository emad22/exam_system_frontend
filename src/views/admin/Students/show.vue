...
const labels = {
    ...
    performanceMatrix: "Performance Overview",
    ...
    skillMasteryMatrix: "Skill Progress",
    ...
    queryLoading: "Loading student data...",
    noSessionHistory: "No evaluation session history available",
    noEvaluationData: "No evaluation data recorded for this student.",
    institutionalReport: "Student Report",
