...
const t = {
    ...
    en: {
        ...
        activeSystem: "Student Registration",
        coreIdentity: "Student Details",
                                ...
                                <template #content>
                                    <div class="p-8 space-y-6">
                                        ...
                                        <div class="flex flex-col space-y-1.5">
                                            ...
                                            <Select v-model="form.partner_id" :options="partners"
                                        ...
                                        <div class="flex flex-col space-y-1.5">
                                            ...
                                            <Select v-model="form.package_id" :options="packages" optionLabel="name"
                                        ...
                                        <!-- Retry Logic Control -->
                                        <div
                                            class="flex items-center p-4 bg-rose-50/20 rounded-2xl border border-rose-500/10 shadow-sm">
                                            <Checkbox v-model="form.allows_retry" :binary="true"
                                                inputId="retry_toggle" />
                                            <label for="retry_toggle"
                                        ...
                                        <div
                                            class="flex items-center p-4 bg-violet-50/20 rounded-2xl border border-violet-500/10 shadow-sm">
                                            <Checkbox v-model="form.is_demo" :binary="true" inputId="is_demo_toggle" />
                                            <label for="is_demo_toggle"
                                                class="ml-3.5 mr-3.5 flex flex-col cursor-pointer">
                                                <span
                                                    class="text-xs font-black text-slate-800 uppercase tracking-wider">{{
                                        ...
                                        <div v-if="form.is_demo"
                                            class="flex items-center p-4 bg-amber-50/20 rounded-2xl border border-amber-500/10 shadow-sm animate-in fade-in duration-300">
                                            <Checkbox v-model="form.is_demo_proctored" :binary="true"
                                                inputId="is_demo_proctored_toggle" />
                                            <label for="is_demo_proctored_toggle"
                                                class="ml-3.5 mr-3.5 flex flex-col cursor-pointer">
                                                <span
                                                    class="text-xs font-black text-slate-800 uppercase tracking-wider">{{
